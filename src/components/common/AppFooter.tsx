      ...
      <div className="w-full flex flex-col items-start justify-between gap-6 md:flex-row md:gap-0">
        <div className="flex flex-col items-start gap-4">
          <div className="flex flex-col items-start">
            ...
            */}
            <h3 className="scroll-m-20 text-base md:text-2xl font-semibold tracking-tight">보유스킬: C#,ASP, ASP.NET WEBFORM CORE MVC , WINFORM, WPF</h3>
            <h3 className="scroll-m-20 text-base md:text-2xl font-semibold tracking-tight">Node.js, Zustand, Shadcn/UI, Tailwinnd css, TYPESCRIPT</h3>
            <h3 className="scroll-m-20 text-base md:text-2xl font-semibold tracking-tight"> 등을 활용한 REACT,JQUERY</h3>
